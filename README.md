...
## Régression : Estimation du prix de voitures d'occasion
...
* **Challenge Scikit-Learn :** Utiliser la **Régression Linéaire**. Mise en place obligatoire du `StandardScaler`.
